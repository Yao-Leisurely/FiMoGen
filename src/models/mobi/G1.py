...
class G1(Model_Template):
    def __init__(self):
        ...
        self.T = 20
        self.input_shape1 = [1, 96, 128, 3]  # 1 帧条件
        self.input_shape2 = [self.T, 96, 128, 28]  # T 帧姿态
    ...
    def _build_model(self):
        ...
        x_cd = Reshape([1, 96, 128, 3])(inp_cond)
        ...
        x_ps = Reshape([self.T, 96, 128, 28])(inp_pose)
    ...
    def prediction(self, Ic, Pt):
        ...
        def compute_pose_with_delta(pose):
            ...
            zero_frame = tf.zeros([batch_size, 1, 96, 128, 14], dtype=pose.dtype)
